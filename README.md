...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pyrsmq-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12581&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pyrsmq-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pyrsmq` can be installed with:

```
conda install pyrsmq
```

It is possible to list all of the versions of `pyrsmq` available on your platform with:
